...
namespace noise
{
    ...
    namespace module
    {
        ...
        public:
            ...
            Perlin();
            Perlin(int octaveCount, double frequency);
            Perlin(int octaveCount, double frequency, double persistence);
            Perlin(int octaveCount, double frequency, double persistence, double lacunarity);
