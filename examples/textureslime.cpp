...
int main()
{
    ...
    CreatePlanarTexture(finalSlime, false, TEXTURE_HEIGHT, "textureplane.bmp");
    CreatePlanarTexture(finalSlime, true, TEXTURE_HEIGHT, "textureseamless.bmp");
    CreateSphericalTexture(finalSlime, TEXTURE_HEIGHT, "texturesphere.bmp");
