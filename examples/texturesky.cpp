...
void CreatePlanarTexture(const module::ModuleBase& lowerNoiseModule, const module::ModuleBase& upperNoiseModule, bool seamless, int height, const char* filename);
...
void CreateSphericalTexture(const module::ModuleBase& lowerNoiseModule, const module::ModuleBase& upperNoiseModule, int height, const char* filename);

// Given two noise maps, this function renders two texture maps and combines
// them to form a Windows bitmap (*.bmp) file.
void RenderTexture(const utils::NoiseMap& lowerNoiseMap, const utils::NoiseMap& upperNoiseMap, const char* filename);
...
int main()
{
    ...
    CreatePlanarTexture(finalWater, finalClouds, false, TEXTURE_HEIGHT, "textureplane.bmp");
    CreatePlanarTexture(finalWater, finalClouds, true, TEXTURE_HEIGHT, "textureseamless.bmp");
    CreateSphericalTexture(finalWater, finalClouds, TEXTURE_HEIGHT, "texturesphere.bmp");
