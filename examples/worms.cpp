...
void Worm::Draw() const
{
    ...
    for (int curSegment = 0; curSegment < m_segmentCount; curSegment++)
    {
        ...
        double noiseValue = m_noise.getValue(curNoisePos.x, curNoisePos.y, curNoisePos.z);
...
void Worm::Update()
{
    ...
    double noiseValue = m_noise.getValue( m_headNoisePos.x, m_headNoisePos.y, m_headNoisePos.z);
